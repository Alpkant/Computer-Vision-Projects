...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action3x3_3 = QtWidgets.QAction(MainWindow)
        self.action3x3_3.setObjectName("action3x3_3")
        self.action5x5_2 = QtWidgets.QAction(MainWindow)
        self.action5x5_2.setObjectName("action5x5_2")
        self.action7x7_2 = QtWidgets.QAction(MainWindow)
        self.action7x7_2.setObjectName("action7x7_2")
        self.action9x9_2 = QtWidgets.QAction(MainWindow)
        self.action9x9_2.setObjectName("action9x9_2")
        self.action11x11_2 = QtWidgets.QAction(MainWindow)
        self.action11x11_2.setObjectName("action11x11_2")
        self.action13x13_2 = QtWidgets.QAction(MainWindow)
        self.action13x13_2.setObjectName("action13x13_2")
        self.action15x15_2 = QtWidgets.QAction(MainWindow)
        self.action15x15_2.setObjectName("action15x15_2")
        ...
        self.menuAverage_Filters.addAction(self.gaussian3x3)
        self.menuAverage_Filters.addAction(self.gaussian5x5)
        self.menuAverage_Filters.addAction(self.gaussian7x7)
        self.menuAverage_Filters.addAction(self.gaussian9x9)
        self.menuAverage_Filters.addAction(self.gaussian11x11)
        self.menuAverage_Filters.addAction(self.gaussian13x13)
        self.menuAverage_Filters.addAction(self.gaussian15x15)
        self.menuGaussian_Filters.addAction(self.action3x3_3)
        self.menuGaussian_Filters.addAction(self.action5x5_2)
        self.menuGaussian_Filters.addAction(self.action7x7_2)
        self.menuGaussian_Filters.addAction(self.action9x9_2)
        self.menuGaussian_Filters.addAction(self.action11x11_2)
        self.menuGaussian_Filters.addAction(self.action13x13_2)
        self.menuGaussian_Filters.addAction(self.action15x15_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action3x3_3.setText(_translate("MainWindow", "3x3"))
        self.action5x5_2.setText(_translate("MainWindow", "5x5"))
        self.action7x7_2.setText(_translate("MainWindow", "7x7"))
        self.action9x9_2.setText(_translate("MainWindow", "9x9"))
        self.action11x11_2.setText(_translate("MainWindow", "11x11"))
        self.action13x13_2.setText(_translate("MainWindow", "13x13"))
        self.action15x15_2.setText(_translate("MainWindow", "15x15"))
